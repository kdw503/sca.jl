...
for (prefix, initmethods, tailstrs) in [("lcsvd", ["isvd","isvd"], ["_sp","_sp_nn"]),
                ("lcsvd_incsvd", ["custom","custom"], ["_sp","_sp_nn"]),
                ("lcsvd_precon", ["isvd","isvd"], ["_sp","_sp_nn"]),
                ("lcsvd_precon_incsvd", ["custom","custom"], ["_sp","_sp_nn"])]
    for SNR = SNRs
        rt2_min = Inf
...
plottime = Inf
for (mtdstr, submtdstrs) in [("lcsvd",["_sp", "_sp_nn"]),
                            ("lcsvd_incsvd",["_sp", "_sp_nn"]),
                            ("lcsvd_precon",["_sp", "_sp_nn"]),
                            ("lcsvd_precon_incsvd",["_sp", "_sp_nn"])]
    @show mtdstr
...
for (i,(mtdstr, submtdstr, lbl, clridx, linestyle)) in enumerate([("lcsvd_precon","_sp","LCSVD precond isvd (α=0.005,β=0)",2,:dash),
                                                                  ("lcsvd_precon_incsvd","_sp","LCSVD precond incsvd (α=0.005,β=0)",4,:dashdot),
                                                                  ("lcsvd","_sp_nn","LCSVD isvd (α=0.005,β=5.0)",6,:dash),
                                                                  ("lcsvd_incsvd","_sp_nn","LCSVD incsvd (α=0.005,β=5.0)",3,:dashdot)])
...
idx == 1 && axislegend(ax, labelsize=10, position = :rb) # halign = :left, valign = :top
