...
# Panel SNR
fname = joinpath(subworkpath, "SNR_fast", "avgfits-10db1f15s_all.png")
...
fname = joinpath(subworkpath, "SNR_fast", "avgfits30db1f15s_all.png")
...
# Panel NOC
fname = joinpath(subworkpath, "ncells_fast", "avgfits0db1f10s_all.png")
...
fname = joinpath(subworkpath, "ncells_fast", "avgfits0db1f20s_all.png")
...
fname = joinpath(subworkpath, "ncells_fast", "avgfits0db1f30s_all.png")
axf=AMakie.Axis(g2[1,3], title="(g) NOC = 30", titlesize=fontsize, aspect = DataAspect())
hidedecorations!(axf, label=false); hidespines!(axf); image!(axf, rotr90(load(fname)))
fname = joinpath(subworkpath, "ncells_fast", "avgfits0db1f50s_all.png")
...
# Panel size
fname = joinpath(subworkpath, "size_fast", "avgfits0db0.7f15s_all.png")
...
fname = joinpath(subworkpath, "size_fast", "avgfits0db1f15s_all.png")
...
fname = joinpath(subworkpath, "size_fast", "avgfits0db5f15s_all.png")
...
fname = joinpath(subworkpath, "size_fast", "avgfits0db10f15s_all.png")
...
save(joinpath(subworkpath,"scalability","scalability_all_figures(4X3)_fast.png"),f,px_per_unit=2)
...
hidedecorations!(axa, label=false); hidespines!(axa); image!(axa, rotr90(load(fname)))
fname = joinpath(subworkpath, "SNRwPP_fast", "avgfits-10db1f15s_all.png")
