...
mfmethod = :LCSVD; useprecond=false; uselv=false; s=10; lcsvdmaxiter = lcsvd_maxiter; tol=-1 
...
prefix = "compnmf"
@show prefix; flush(stdout)
mfmethod = :COMPNMF; cnmaxiter = compnmf_maxiter
...
mfmethod = :HALS; αhals=0.1; halsmaxiter = hals_maxiter; tol=-1 # αhals=0.6 
