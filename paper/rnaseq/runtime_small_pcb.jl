...
αrng = 0.0001:0.0005:0.01; fitvals = []; sws = []
β = 3.0
tailstr = "_sp_nn"
initmethod = :isvd
...
jldfprex = "$(file_name)$(Xtpstr)_ss$(sizestep)_pcb_noc$(noc)_αrng"
fname = joinpath(subworkpath,"$(jldfprex).jld2")
...
ax1 = AMakie.Axis(fig[1, 1], limits=(nothing, (0.,1.1) ), xlabel = "α", ylabel = "fit", title = "Fit Value vs. α")
