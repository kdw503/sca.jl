...
# feature_name, ncells, noc, nac, α1, α2, β1, β2, pcb_maxiter = "WMB-10Xv2-HY", 0, 500, 2500, 0.005, 0.005, 5.0, 5.0, 0
...
method = "pcb"
file_name = feature_name*"-rawt"
@show "solve"
useprecond=false; uselv=false; tol=1e-6
σ0=std(H0t*N0t); r=0.3; maxiter = pcb_maxiter == 0 ? Int(ceil(log(eps(eltype(X)))/log(r))) : pcb_maxiter
...
# jldfprex = "WMB-10Xv3-raw_n2349544_initnndisvd_hals_noc500_a0.1_tol0.003_mit50_nrrd"
