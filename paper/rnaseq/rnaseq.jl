...
open(joinpath(fgpath,"WMB-10Xv3-raw.nrrd"),"w") do io   # write data
    for fm_label in ["WMB-10Xv3-CB","WMB-10Xv3-CTXsp","WMB-10Xv3-HPF","WMB-10Xv3-HY"
        ...
        feature_matrix_label = fm_label; scale="raw"
...
header["datafile"] = "WMB-10Xv3-raw.nrrd"
open(joinpath(fgpath,"WMB-10Xv3-raw.nhdr"),"w") do io # write header
...
# read from site
feature_name = "WMB-10Xv3-CB"; scale="raw"
...
X = sqrt.(adata.X'); sizey, sizex = size(X)
# write data
...
feature_name = "WMB-10Xv2-HY"; scale="raw" # WMB-10Xv2-HY(32285×100562)
feature_group = first(feature_name,9)
fgpath = joinpath(datapath,"AllenBrain","expression_matrices",feature_group)
file_name = feature_name*"-raw"
X = load(joinpath(fgpath,file_name*".nhdr")).data
