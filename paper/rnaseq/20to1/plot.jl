...
# sizestep, pcb_maxiter, pcb_inner_maxiter, tol, per_component = 20, 1, 1, 1e-6, false
...
# αrng
fname = joinpath(subworkpath,"WMB-10Xv2-HY-rawt_ss20_pcb_noc500_αrng0.01.jld2")
dd = load(fname)
αrng = dd["αrng"]; fitvals = dd["fitvals"]; sws = dd["sws"]; β = dd["β"]; noc=500

labels = ["fitval","norm(sw,1)"]
fig = Figure(resolution = (500,300))
ax1 = AMakie.Axis(fig[1, 1], limits=(nothing, (0.99,1.0) ), xlabel = "α", ylabel = "fit", title = "Fit Value vs. α")
ax2 = AMakie.Axis(fig[1, 1], limits=(nothing, (2000,3000) ), yaxisposition = :right, ylabel = "Sparseness of W" #= yticklabelcolor = :red =# )
...
# βrng
fname = joinpath(subworkpath,"WMB-10Xv2-HY-rawt_ss20_pcb_noc500_βrng10000.jld2")
dd = load(fname)
...
βrng = [0.1, 0.5, 1.0, 3.0, 5.0, 7.0, 9.0, 10.0, 30.0, 50.0, 70.0, 90.0, 100.0, 200, 400, 600, 800, 1000.0, 2000, 4000, 5000, 6000, 8000, 10000]
...
# nacrng
fname = joinpath(subworkpath,"WMB-10Xv2-HY-rawt_ss20_pcb_nacrng.jld2")
dd = load(fname)
nacrng = dd["nacrng"]; fitvals = dd["fitvals"]; nsws = dd["nsws"]; β = dd["β"]; α = dd["α"]; noc=500

nacrngfnames = [(300,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac300_a0.005_b3.0_it12.jld2"),
                (400,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac400_a0.005_b3.0_it10.jld2"),
                (500,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac500_a0.005_b3.0_it11.jld2"),
                (600,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac600_a0.005_b3.0_it11.jld2"),
...
fig[:,2] = Legend(fig[:,1],[ln1,ln2],labels)
save(joinpath(subworkpath,"fit_and_sparsity_nacrng_noc$(noc)_a$(α)_b$(β).png"),fig)
...
halsnocrngfnames = [(300,"WMB-10Xv2-HY-rawt_ss20_hals_noc300_a0.1_mit500.jld2"),
                    (400,"WMB-10Xv2-HY-rawt_ss20_hals_noc400_a0.1_mit500.jld2"),
                    (500,"WMB-10Xv2-HY-rawt_ss20_hals_noc500_a0.1_mit500.jld2"),
                    (600,"WMB-10Xv2-HY-rawt_ss20_hals_noc600_a0.1_mit500.jld2"),
                    (700,"WMB-10Xv2-HY-rawt_ss20_hals_noc700_a0.1_mit500.jld2"),
                    (800,"WMB-10Xv2-HY-rawt_ss20_hals_noc800_a0.1_mit500.jld2"),
                    (900,"WMB-10Xv2-HY-rawt_ss20_hals_noc900_a0.1_mit500.jld2"),
                    (1000,"WMB-10Xv2-HY-rawt_ss20_hals_noc1000_a0.1_mit500.jld2")]
...
labels = ["fitval","norm(sw,1)"]
fig = Figure(resolution = (500,300))
ax1 = AMakie.Axis(fig[1, 1], limits=((0,50), (0.9953,0.9960)), xlabel = "β", ylabel = "fit", title = "Fit Value vs. β")
ax2 = AMakie.Axis(fig[1, 1], limits=((0,50), (4000.,9000.) ), yaxisposition = :right, ylabel = "Sparseness of W" #= yticklabelcolor = :red =# )
ln1 = lines!(ax1, βrng, fitvals, color=mtdcolors[1], label=labels[1])
ln2 = lines!(ax2, βrng, sws, color=mtdcolors[1], label=labels[2], linestyle = :dash, linewidth = 2)
fig[:,2] = Legend(fig[:,1],[ln1,ln2],labels)
save(joinpath(subworkpath,"fit_and_sparsity_βhrng_noc$(noc)_aw$(α).png"),fig)

# nocrng
fname = joinpath(subworkpath,"WMB-10Xv2-HY-rawt_ss20_pcb_nocrng_awbh.jld2")
dd = load(fname)
nocrng = dd["nocrng"]; fitvals = dd["fitvals"]; nsws = dd["nsws"]; β = dd["β"]; α = dd["α"]

labels = ["fitval","norm(sw,1)/noc"]
fig = Figure(resolution = (500,300))
ax1 = AMakie.Axis(fig[1, 1], limits=((300,1000), (0.98,1.0)), xlabel = "noc", ylabel = "fit", title = "Fit Value vs. noc")
ax2 = AMakie.Axis(fig[1, 1], limits=((300,1000), (16.,17.)), yaxisposition = :right, ylabel = "Sparseness of W" #= yticklabelcolor = :red =# )
ln1 = lines!(ax1, nocrng, fitvals, color=mtdcolors[1], label=labels[1])
ln2 = lines!(ax2, nocrng, nsws, color=mtdcolors[1], label=labels[2], linestyle = :dash, linewidth = 2)
fig[:,2] = Legend(fig[:,1],[ln1,ln2],labels)
save(joinpath(subworkpath,"fit_and_sparsity_pcb_nocrng_aw$(α)_bh$(β).png"),fig)

# nacrng
fname = joinpath(subworkpath,"WMB-10Xv2-HY-rawt_ss20_pcb_nacrng_awbh.jld2")
dd = load(fname)
nacrng = dd["nacrng"]; fitvals = dd["fitvals"]; nsws = dd["nsws"]; β = dd["β"]; α = dd["α"]; noc=500

nacrngfnames = [(300,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac300_aw0.005_bh3.0_it2.jld2"),
                (400,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac400_aw0.005_bh3.0_it2.jld2"),
                (500,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac500_aw0.005_bh3.0_it2.jld2"),
                (600,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac600_aw0.005_bh3.0_it3.jld2"),
                (700,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac700_aw0.005_bh3.0_it3.jld2")#=,
                (800,"WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac800_aw0.005_bh3.0_it8.jld2"),
                (900,"WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac900_aw0.005_bh3.0_it6.jld2"),
                (1000,"WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac1000_aw0.005_bh3.0_it3.jld2")=#
                ]
nacrng = Float64[]; fitvals = Float64[]; nsws = Float64[]
for (nac,jldfname) in nacrngfnames
#    @show nac
...
ln2 = lines!(ax2, nacrng, nsws, color=mtdcolors[1], label=labels[2], linestyle = :dash, linewidth = 2)
fig[:,2] = Legend(fig[:,1],[ln1,ln2],labels)
save(joinpath(subworkpath,"fit_and_sparsity_nacrng_noc$(noc)_aw$(α)_bh$(β).png"),fig)


# noc vs nac
nocrngfnames = [(300,"WMB-10Xv2-HY-rawt_ss20_pcb_noc300_aw0.005_bh3.0_it2.jld2"),
                (400,"WMB-10Xv2-HY-rawt_ss20_pcb_noc400_aw0.005_bh3.0_it2.jld2"),
                (500,"WMB-10Xv2-HY-rawt_ss20_pcb_noc500_aw0.005_bh3.0_it2.jld2"),
                (600,"WMB-10Xv2-HY-rawt_ss20_pcb_noc600_aw0.005_bh3.0_it2.jld2"),
                (700,"WMB-10Xv2-HY-rawt_ss20_pcb_noc700_aw0.005_bh3.0_it2.jld2"),
                (800,"WMB-10Xv2-HY-rawt_ss20_pcb_noc800_aw0.005_bh3.0_it2.jld2"),
                (900,"WMB-10Xv2-HY-rawt_ss20_pcb_noc900_aw0.005_bh3.0_it2.jld2"),
                (1000,"WMB-10Xv2-HY-rawt_ss20_pcb_noc1000_aw0.005_bh3.0_it2.jld2")]
noctms = Float64[]; nocfitvals = Float64[]; nocnsws = Float64[]
for (noc,jldfname) in nocrngfnames
    fname = joinpath(subworkpath,jldfname)
    dd = load(fname)
...
nacrngfnames = [(300,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac300_aw0.005_bh3.0_it2.jld2"),
                ...
                (600,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac600_aw0.005_bh3.0_it3.jld2"),
                (700,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac700_aw0.005_bh3.0_it3.jld2")#=,
                (800,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac800_aw0.005_bh3.0_it8.jld2"),
                (900,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac900_aw0.005_bh3.0_it6.jld2"),
                (1000,"./nac_old/WMB-10Xv2-HY-rawt_ss20_pcb_noc500_nac1000_aw0.005_bh3.0_it3.jld2")=#
                ]
nactms = Float64[]; nacfitvals = Float64[]; nacnsws = Float64[]
for (nac,jldfname) in nacrngfnames
#    @show nac
    fname = joinpath(subworkpath,jldfname)
    dd = load(fname)
...
ln4 = lines!(ax2, nactms, nacnsws, color=mtdcolors[2], label=labels[4], linestyle = :dash, linewidth = 2)
fig[:,2] = Legend(fig[:,1],[ln1,ln2,ln3,ln4],labels)
save(joinpath(subworkpath,"fit_and_sparsity_time_nocrng_nacrng_aw$(α)_bh$(β).png"),fig)
...
753176  kim503  RUN   general    compute1-cl compute1-ex *seq/expr2 Dec 10 09:15 ("hals", "noc", 5, 300~1000) iter2000 500.1700ing...
#603898  kim503  RUN   general    compute1-cl compute1-ex *seq/expr4 Dec  4 09:43 ("pcb", "nac both", 5) 1000.1ing
#716141  kim503  PEND  general    compute1-cl             *seq/expr5 Dec  9 18:56 ("hals", "noc", 5, 300~1000) iter500 (1000.354ing...)
746591  kim503  RUN   general    compute1-cl compute1-ex *seq/expr1 Dec 10 16:28 ("pcb", "noc both", 5, 800~1400) ("noc both", 5, 600~1400) 600.1ing