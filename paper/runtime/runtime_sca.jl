...
for (tailstr,initmethod,α,β) in [("_sp",:nndsvd,100.,0.), ("_sp_nn",:nndsvd,100.,1000.)] #("_nn",:nndsvd,0.,1000.), 
    ...
    save(joinpath(subworkpath,"sca","sca$(tailstr)_results$(iter).jld2"),"metadata",metadata,"data",dd)
    GC.gc()
end
catch e
...
save(joinpath(subworkpath,"sca_runtime_vs_avgfits.jld2"),"rng",rng, "stat_nn", stat_nn, "stat_sp", stat_sp, "stat_sp_nn", stat_sp_nn)
